...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    github_cta: "Explore more on GitHub",
  ...
  pt: {
    ...
    hero_explore: "Veja meus trabalhos",
      ...
      about_p1: "Sou Front-end Developer com experiência em construir aplicações web modernas desde 2021. Sou apaixonada pela interseção entre design e tecnologia.",
    ...
    github_cta: "Veja mais no GitHub",
    live_project: "Projeto ao vivo",
    contact_label: "Fale comigo",
    contact_title: "Vamos construir algo incrível juntos.",
    contact_paragraph: "Estou sempre interessada em conectar-me com pessoas que estão construindo produtos significativos e resolvendo problemas interessantes.",
